export interface Env {
    ...
    RECIPIENT_MONTHLY_OFFER_REFERENCE_NAME?: string; RECIPIENT_YEARLY_OFFER_REFERENCE_NAME?: string;
    ...
    SENDER_NEW_MONTHLY_OFFER_REFERENCE_NAME?: string; SENDER_NEW_YEARLY_OFFER_REFERENCE_NAME?: string;
